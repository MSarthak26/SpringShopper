...
@Service //this tells spring to manage this as a bean
...
//    private List<Category> categories = new ArrayList<>();
    ...
    public CategoryResponse getAllCategories(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        categoryResponse.setTotalElements((long) categoryPage.getTotalPages());
    ...
    public CategoryDTO deleteCategory(Long categoryId) {
        ...
        Category savedCategoryDTO = categoryRepository.findById(categoryId)
                .orElseThrow(()->new ResourceNotFoundException("category","category Id", String.valueOf(categoryId)));

        categoryRepository.delete(savedCategoryDTO);
    ...
    public CategoryDTO updateCategory(CategoryDTO categoryDTO, Long categoryId) {
        ...
        Category savedCategory = categoryFromDB.
                orElseThrow(()->new ResourceNotFoundException("category","category Id", String.valueOf(categoryId)));

        Category category = modelMapper.map(categoryDTO,Category.class);
        savedCategory.setCategoryName(category.getCategoryName());

        Category savedCategoryDTO = categoryRepository.save(savedCategory);
        return modelMapper.map(savedCategoryDTO,CategoryDTO.class);
