...
import SpringBootEcom.repository.RoleRepository;
import SpringBootEcom.repository.UserRepository;
import SpringBootEcom.security.jwt.JwtUtils;
import SpringBootEcom.security.request.LoginRequest;
import SpringBootEcom.security.request.SignupRequest;
import SpringBootEcom.security.response.MessageResponse;
import SpringBootEcom.security.response.UserInfoResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest){
        ...
        ResponseCookie jwtCookie = jwtUtils.generateCookieFromUsername(userDetails);
        List<String> roles = userDetails.getAuthorities().stream().map(item->item.getAuthority()).toList();

        UserInfoResponse userInfoResponse = new UserInfoResponse(userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(),roles,jwtCookie.toString());
